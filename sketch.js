...
function setup() {
  ...
  ball1 = new Obstacle(700,120,40,40);
  rope1 = new Rope(ball1.body,{x:600,y:0});
  ball2 = new Obstacle(900,120,40,40);
  rope2 = new Rope(ball2.body,{x:800,y:0});
  ball3 = new Obstacle(1100,120,40,40);
  rope3 = new Rope(ball3.body,{x:1000,y:0});
}
